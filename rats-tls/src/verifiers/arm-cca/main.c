...
extern enclave_verifier_err_t arm_cca_verify_evidence(enclave_verifier_ctx_t *,
						     attestation_evidence_t *, uint8_t *,
						     unsigned int hash_len,
						     attestation_endorsement_t *endorsements);
extern enclave_verifier_err_t arm_cca_verifier_cleanup(enclave_verifier_ctx_t *);
...
#ifdef SGX
void libverifier_arm_cca_init(void)
#else
...
#endif
{
	...
	enclave_verifier_err_t err = enclave_verifier_register(&arm_cca_verifier_opts);
